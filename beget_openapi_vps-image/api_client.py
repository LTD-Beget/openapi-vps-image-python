...
from beget_openapi_vps-image import rest
from beget_openapi_vps-image.configuration import Configuration
from beget_openapi_vps-image.exceptions import ApiTypeError, ApiValueError
from beget_openapi_vps-image.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/v1.0.6/python'
