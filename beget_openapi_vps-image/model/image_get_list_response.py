...
class ImageGetListResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class images(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ImageImage'], typing.List['ImageImage']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["images", "total_count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["images", "total_count", ], str]):
