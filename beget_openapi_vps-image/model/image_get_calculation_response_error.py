...
class ImageGetCalculationResponseError(
    schemas.DictSchema
):
            ...
            class code(
                ...
                class MetaOapg:
                    ...
                    enum_value_to_name = {
                        ...
                        "IMPOSSIBLE_TO_CALCULATE": "IMPOSSIBLE_TO_CALCULATE",
                    }
                ...
                @schemas.classproperty
                def IMPOSSIBLE_TO_CALCULATE(cls):
                    return cls("IMPOSSIBLE_TO_CALCULATE")
